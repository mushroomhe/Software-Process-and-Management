...
<div class="container-fluid">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="#">河北省重大技术需求征集问卷调查系统</a>
	</div>
	...
	<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		...
		<li><a target="_parent" href="">管理员  ${adminBean.username }您好！</a></li>
				
				<li role="separator" class="divider"></li>
				<li><a target="_parent" href="${pageContext.request.contextPath }/AdminServlet?method=end">退出登录</a></li>
